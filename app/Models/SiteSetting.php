...
class SiteSetting extends Model
{
    ...
    public static function publicContent(): array
    {
        return [
            ...
            'profile_vision' => 'Menjadi ekstrakurikuler musik sebagai ruang yang kreatif, solid, disiplin, dan menyenangkan untuk menyalurkan bakat dan prestasi dalam bidang musik.',
            'profile_mission' => "Mengembangkan bakat musik siswa\nMelatih kerja sama dan kedisiplinan\nMemberi ruang tampil dan berkarya",
            'profile_board' => "Pembina Eskul Musik\nKetua Eskul\nWakil Ketua Eskul\nSekretaris\nBendahara\nSerta bidang sie lainnya",
            'profile_schedule' => 'Latihan rutin dilaksanakan pada hari Selasa dan Rabu sepulang sekolah. Jika ada event besar, kami akan menambah hari latihan bersama.',
